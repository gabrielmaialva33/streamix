defmodule Streamix.Iptv.Gindex.Sync.NormalizersTest do
  use ExUnit.Case, async: true

  alias Streamix.Iptv.Gindex.Sync.Normalizers.Episode
  alias Streamix.Iptv.Gindex.Sync.Normalizers.Movie
  alias Streamix.Iptv.Gindex.Sync.Normalizers.Season
  alias Streamix.Iptv.Gindex.Sync.Normalizers.Series
