defmodule Streamix.ContextBoundariesTest do
  ...
  @baseline MapSet.new([
              ...
              "lib/streamix/ai/user_analytics/channels.ex alias Streamix.Iptv.History",
              "lib/streamix/ai/user_analytics/channels.ex alias Streamix.Iptv.LiveChannel",
              "lib/streamix/ai/user_analytics/insights.ex alias Streamix.Iptv.Genre",
              "lib/streamix/ai/user_analytics/insights.ex alias Streamix.Iptv.History",
              "lib/streamix/ai/user_analytics/personalized_content.ex alias Streamix.Iptv.Catalog",
              "lib/streamix/ai/user_analytics/profile.ex alias Streamix.Iptv.History",
              "lib/streamix/ai/user_analytics/recommendations.ex alias Streamix.Iptv.History",
