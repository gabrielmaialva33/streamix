defmodule StreamixWeb.UserAuthTest do
  ...
  @remember_me_cookie "_streamix_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, StreamixWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
