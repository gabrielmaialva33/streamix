...
const ContentCard = {
  ...
  buildPreviewHTML() {
    ...
    const metadata = [this.year, this.genre, this.duration].filter(Boolean).join(" • ");
      ...
      <div class="relative">
        ${
          ...
          <div class="aspect-video bg-surface-hover overflow-hidden">
            <img src="${this.cover}" alt="${this.escapeHtml(this.title)}" class="w-full h-full object-cover" />
