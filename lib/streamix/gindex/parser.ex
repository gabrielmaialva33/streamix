defmodule Streamix.Gindex.Parser do
  @moduledoc """
  Public facade for GIndex file and folder name parsing.

  The focused parser modules live under `Streamix.Gindex.Parser.*`; keep
  this module as the stable API used by scrapers, sync code, and tests.
  """

  alias Streamix.Gindex.Parser.{AnimeEpisode, Files, Folders, ReleaseFolder, ReleaseName}
